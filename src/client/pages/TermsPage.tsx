    ...
    <div>
      ...
      >
        ...
        <Section title="第1条（適用）">
          本規約は、ユーザーと本サービスの運営者（以下「運営者」）との間の、本サービスの利用に関わる
          一切の関係に適用されます。運営者が本サービス上で別途定める個別規定やガイドラインは、本規約の
          一部を構成するものとします。
        </Section>
        ...
        <Section title="第14条（準拠法・裁判管轄）">
          本規約の解釈には日本法を準拠法とします。本サービスに関して紛争が生じた場合には、運営者の所在地を
          管轄する裁判所を専属的合意管轄とします。
        </Section>

        <Section title="お問い合わせ">
          本規約または本サービスに関するお問い合わせは、運営者の定める窓口までご連絡ください。
        </Section>
